  ...
  return (
    ...
    >
        <div
            ...
            style={{ position: "absolute", bottom: "10%", backgroundColor: "transparent" }}
        >
            <p className="text-lg text-white mb-6">Estamos trabajando para traerte una nueva experiencia.</p>
